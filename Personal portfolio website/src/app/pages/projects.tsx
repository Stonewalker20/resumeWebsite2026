    ...
    <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="grid grid-cols-12 gap-4 mb-8">
        <div className="col-span-12 lg:col-span-8 row-span-2 glass-dark border border-primary/20 clip-corner-all overflow-hidden group relative">
          <div className="overflow-hidden relative bg-gradient-to-br from-primary/15 via-transparent to-secondary/20 p-3 md:p-4">
            <div className="absolute inset-0 bg-gradient-to-t from-card via-card/50 to-transparent"></div>
            {portfolio.caseStudies[0].previewImages ? (
              <div className="relative z-10 grid grid-cols-1 md:grid-cols-[1.14fr_1fr] gap-2 items-start">
                <div className="overflow-hidden border border-border/70 clip-corner-tl bg-background/20 p-2 md:p-2.5">
                ...
                <div className="grid gap-2">
                  {portfolio.caseStudies[0].previewImages.slice(1).map((image, index) => (
                    <div
                      key={image.src}
                      className={`overflow-hidden border border-border/70 bg-background/20 p-1.5 md:p-2 ${
